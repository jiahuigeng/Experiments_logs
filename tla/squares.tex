...
\begin{document}
\tlatex
\fl{}\moduleLeftDash\cl{ {\MODULE} squares}\moduleRightDash\cl{}
\fl{ {\EXTENDS} TLC ,\, Integers}
\fl{}
\fl{ {\p@mmalgorithm} squares}
\fl{ {\p@variables}}
\fl{ x \.{\in} 1 \.{\dotdot} 10 {\p@semicolon}}
\fl{}
\fl{ {\p@begin}}
\fl{ {\p@assert} x ^{ 2} \.{\leq} 100 {\p@semicolon}}
...
\fl{ {\VARIABLES} x ,\, pc}
\fl{}
\fl{ vars}\al{13}{1}{ \.{\defeq} {\langle} x ,\, pc {\rangle}}
\fl{}
\fl{ Init}\al{15}{1}{ \.{\defeq}}\al{15}{2}{%
\@y{\@s{0}%
 Global variables
}%
}
\fl{ \.{\land}}\al{16}{1}{ x \.{\in} 1 \.{\dotdot} 10}
\fl{ \.{\land}}\al{17}{1}{ pc \.{=}\@w{Lbl\_1}}
\fl{}
\fl{ Lbl\_1 \.{\defeq}}\al{19}{2}{ \.{\land}}\al{19}{3}{ pc \.{=}\@w{Lbl\_1}}
 \fl{ \.{\land}}\al{20}{1}{ Assert ( x ^{ 2} \.{\leq} 100 ,\,\@w{Failure\ of\
 assertion\ at\ line\ 9,\ column\ 5.} )}
\fl{ \.{\land}}\al{21}{1}{ pc \.{'} \.{=}\@w{Done}}
\fl{ \.{\land}}\al{22}{1}{ x \.{'} \.{=} x}
\fl{}
\fl{}
\fl{ Terminating \.{\defeq} pc \.{=}\@w{Done} \.{\land} {\UNCHANGED} vars}
\fl{}
\fl{ Next}\al{27}{1}{ \.{\defeq}}\al{27}{2}{ Lbl\_1}
\fl{ \.{\lor} Terminating}
\fl{}
 \fl{ Spec}\al{30}{1}{ \.{\defeq}}\al{30}{2}{ Init \.{\land} {\Box} [ Next ]_{
 vars}}
\fl{}
\fl{ Termination \.{\defeq} {\Diamond} ( pc \.{=}\@w{Done} )}
\fl{}
\fl{}
\fl{}\bottombar\cl{}
\end{document}
